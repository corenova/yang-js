...
(function (process){
(function(){var e,n,u,l;null!=process.env.yang_debug&&null==console.debug&&(console.debug=console.log),u=require("./yang"),e=require("./yang-extension"),n=require("./yang-typedef"),u.use(e.builtins,n.builtins),l=module.exports=u,l.Extension=e,l.Typedef=n,l.XPath=require("./xpath")}).call(this);
...
(function(){var e,t,n,r,o,i,s,u,l,c=function(e,t){function n(){this.constructor=e}for(var r in t)a.call(t,r)&&(e[r]=t[r]);return n.prototype=t.prototype,e.prototype=new n,e.__super__=t.prototype,e},a={}.hasOwnProperty,f=[].slice;l=require("path"),u=require("yang-parser"),s=require("indent-string"),r=require("clone"),e=require("./expression"),t=require("./model"),n=function(n){function a(t,n,r){return this.constructor!==a?function(){return this.eval.apply(this,arguments)}.bind(a.parse(arguments[0],!0)):(null==r&&(r=this.lookup("extension",t)),r instanceof e||this.once("resolve:before",function(e){return function(){if(r=e.lookup("extension",t),!(r instanceof a))throw e.error("encountered unknown extension '"+t+"'");return e.source=r.source,e.argument=r.argument,r}}(this)),a.__super__.constructor.call(this,t,n,r),void Object.defineProperties(this,{datakey:{get:function(){switch(!1){case!(this.parent instanceof a&&"module"===this.parent.kind):return this.parent.tag+":"+this.tag;default:return this.tag}}.bind(this)}}))}return c(a,n),a.scope={extension:"0..n",typedef:"0..n",module:"0..n",submodule:"0..n"},a.parse=function(e,t){var n,r,o,i,s,l,c;null==t&&(t=!0);try{"string"==typeof e&&(e=u.parse(e))}catch(o){throw r=o,r.offset>50||(r.offset=50),s=e.slice(r.offset-50,r.offset+50),s=s.replace(/\s\s+/g," "),this.error("invalid YANG syntax detected",s)}if(!(e instanceof Object))throw this.error("must pass in valid YANG schema",e);i=function(){switch(!1){case!e.prf:return e.prf+":"+e.kw;default:return e.kw}}(),e.arg&&(c=e.arg),e=new this(i,c)["extends"](e.substmts.map(function(e){return function(t){return e.parse(t,!1)}}(this))),l=e.scope;for(i in l)if(n=l[i],("1"===n||"1..n"===n)&&!e.hasOwnProperty(i))throw e.error("constraint violation for required '"+i+"' = "+n);return t!==!1&&e.resolve(t),e},a.compose=function(t,n){var r,o,i,s,u;if(null==n&&(n={}),null!=n.kind){if(r=a.prototype.lookup.call(this,"extension",n.kind),!(r instanceof e))throw new Error("unable to find requested '"+n.kind+"' extension");return"function"==typeof r.compose?r.compose(t,n):void 0}for(s=this.extension,o=0,i=s.length;i>o;o++)if(r=s[o],r.compose instanceof Function&&("function"==typeof console.debug&&console.debug("checking data if "+r.tag),u=r.compose(t,n),u instanceof a))return u},a.resolve=function(){var e,t,n,r,o,s;if(r=2<=arguments.length?f.call(arguments,0,o=arguments.length-1):(o=0,[]),s=arguments[o++],"string"!=typeof s)return null;for(e=r=function(){switch(!1){case!r.length:return r[0];default:return l.resolve()}}();null==n&&"/"!==e&&"."!==e;){"function"==typeof console.debug&&console.debug("resolving "+s+" in "+e+"/package.json");try{n=require(e+"/package.json").models[s],e=l.dirname(require.resolve(e+"/package.json"))}catch(u){}null==n&&(e=l.dirname(e))}return t=function(){switch(!1){case!(null!=n&&/^[\.\/]/.test(n)):return l.resolve(e,n);case null==n:return this.resolve(n,s)}}.call(this),null==t&&(t=l.resolve(r,s+".yang")),"function"==typeof console.debug&&console.debug("checking if "+t+" exists"),i.existsSync(t)?t:null},a.require=function(e,t){var n,r,o,s,u,c,f,p;if(null==t&&(t={}),null!=e){if(null==t.basedir&&(t.basedir=""),null==t.resolve&&(t.resolve=!0),u=l.extname(e),c=l.resolve(t.basedir,e),n=l.dirname(c),!u)return null!=(f=a.prototype.match.call(this,"module",e))?f:this.require(this.resolve(e),t);if(".yang"!==u)return require(c);try{return this.use(this.parse(i.readFileSync(c,"utf-8"),t.resolve))}catch(s){if(o=s,!t.resolve||"ExpressionError"!==o.name||"include"!==(p=o.context.kind)&&"import"!==p)throw console.error("unable to require YANG module from '"+c+"'"),console.error(o),o;if("include"===o.context.kind&&(t.resolve=!1),r=this.require(this.resolve(n,o.context.tag),t),null==r)throw o.message="unable to auto-resolve '"+o.context.tag+"' dependency module",o;return"function"==typeof console.debug&&console.debug("retrying require("+e+")"),this.require.apply(this,arguments)}}},a.register=function(e){var t;return null==e&&(e={}),null!=(t=require.extensions)&&null==t[".yang"]&&(t[".yang"]=function(t,n){return t.exports=a.require(n,e)}),o},a.prototype.error=function(e,t){return a.__super__.error.call(this,this.trail+"["+this.tag+"] "+e,t)},a.prototype.eval=function(e,n){return this.node!==!0?a.__super__.eval.apply(this,arguments):e instanceof t?e:(e=a.__super__.eval.call(this,r(e),n),new t(this,e.__props__))},a.prototype.locate=function(e){var t,n,r,o,i,s,u,l,c,p,h,d,g,m;if("string"==typeof e&&e){if(e=e.replace(/\s/g,""),/^\//.test(e)&&this!==this.root)return this.root.locate(e);if(u=e.split("/").filter(function(e){return!!e}),n=u[0],d=2<=u.length?f.call(u,1):[],null==n)return this;if(".."===n)return null!=(l=this.parent)?l.locate(d.join("/")):void 0;if(i=n.match(/^([\._-\w]+):([\._-\w]+)$/),null==i)return a.__super__.locate.apply(this,arguments);if(c=[i[1],i[2]],s=c[0],m=c[1],"function"==typeof this.debug&&this.debug("looking for '"+s+":"+m+"'"),d=d.map(function(e){return e.replace(s+":","")}),g=[m].concat(d).join("/"),this.tag===s||this.lookup("prefix",s))return"function"==typeof this.debug&&this.debug("(local) locate '"+g+"'"),a.__super__.locate.call(this,g);for(h=null!=(p=this["import"])?p:[],t=0,r=h.length;r>t;t++)if(o=h[t],o.prefix.tag===s)return"function"==typeof this.debug&&this.debug("(external) locate "+g),o.module.locate(g)}},a.prototype.match=function(e,t){var n,r,o,i,s,u,l,c,p,h,d,g,m;if(null==e||null==t||"string"!=typeof t)return a.__super__.match.apply(this,arguments);if(p=t.split(":"),c=2<=p.length?f.call(p,0,o=p.length-1):(o=0,[]),n=p[o++],!c.length)return a.__super__.match.apply(this,arguments);if(c=c[0],(null!=(h=this.root)&&null!=(d=h.prefix)?d.tag:void 0)===c)return this.root.match(e,n);if(r=this.lookup("belongs-to"),(null!=r?r.prefix.tag:void 0)===c)return r.module.match(e,n);for(i=null!=(g=null!=(m=this.root)?m["import"]:void 0)?g:[],s=0,u=i.length;u>s;s++)if(l=i[s],l.prefix.tag===c)return l.module.match(e,n)},a.prototype.toString=function(e){var t,n;return null==e&&(e={space:2}),t=this.kind,null!=this.source.argument&&(t+=" "+function(){switch(this.source.argument){case"value":return"'"+this.tag+"'";case"text":return"\n"+s('"'+this.tag+'"'," ",e.space);default:return this.tag}}.call(this)),n=this.elements.filter(function(e){return function(t){return t.parent===e}}(this)).map(function(t){return t.toString(e)}).join("\n"),t+=n?" {\n"+s(n," ",e.space)+"\n}":";"},a}(e),o=module.exports=n,o.Model=t}).call(this);
