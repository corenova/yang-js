  ...
  describe 'leaf', ->
    ...
    describe 'extended schema', ->
      ...
      it "should create extended leaf element", ->
        y = yang schema
        o = y foo: null
        o.foo.should.equal(y.source.default.arg)
  ...
  describe 'container', ->
    ...
    describe 'extended schema', ->
      ...
      it "should parse extended container statement", ->
        y = yang schema
        y.source.leaf.should.be.instanceOf(Array).and.have.length(1)
    ...
    describe 'nested schema', ->
      ...
      it "should parse nested container statement", ->
        y = yang schema
        y.source.container.should.be.instanceOf(Array).and.have.length(2)
        ...
        for i in y.enum
          switch i.arg
            when 'apple'
              ...
              i.value.arg.should.equal('0')
            when 'orange'
              i.value.arg.should.equal('20')
            when 'banana'
              i.should.have.property('value')
